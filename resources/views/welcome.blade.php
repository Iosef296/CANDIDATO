...
<section id="acerca" class="contact-section">
  ...
  <div class="about-content">
    ...
    <p>
      3. Valeria Montes (1985 –  ) – Biografía ficticia. Ingeniera
      ambiental nacida en Cusco, Perú. Fundadora de la
      ONG "Ríos Vivos", dedicada a la recuperación de
      cuencas contaminadas en la región andina.
      Reconocida en 2022 con el Premio Internacional de
      Innovación Verde por su sistema de filtración natural
  ...
  <div class="form-wrapper">
    ...
    <form class="cool-form">
      ...
      <div class="form-group">
        ...
        <!-- Campo para email (el type="email" valida automáticamente que sea un email válido esito noma era xddd) -->
      </div>
